...
const EMAIL_SESSION_CANCELLED_WITH_PARTIAL_REFUND_CONSUMER_TEMPLATE_ID =
  Env.getString(
    'EMAIL_SESSION_CANCELLED_WITH_PARTIAL_REFUND_CONSUMER_TEMPLATE_ID'
  )

export const SessionCancelledWithPartialRefundConsumerConfig =
  new NotificationConfig({
    id: NotificationType.SessionCancelledWithPartialRefund,
...
const queueConsumerNotification = async ({
  ...
  await queueNotification({
    ...
    config: SessionCancelledWithPartialRefundConsumerConfig,
    payload,
  })
}

const EMAIL_SESSION_CANCELLED_WITH_PARTIAL_REFUND_EXPERT_TEMPLATE_ID =
  Env.getString(
    'EMAIL_SESSION_CANCELLED_WITH_PARTIAL_REFUND_EXPERT_TEMPLATE_ID'
  )

export const SessionCancelledWithPartialRefundExpertConfig =
  new NotificationConfig({
    id: NotificationType.SessionCancelledWithPartialRefund,
    ...
    templates: [
      ...
      {
        bodyTemplateKey: 'sessionCancellation.expert.plainText.body',
...
const queueExpertNotification = async ({
  ...
  await queueNotification({
    ...
    config: SessionCancelledWithPartialRefundExpertConfig,
    payload,
  })
}

export const queueCancelledSessionWithPartialRefundNotifications = async (
