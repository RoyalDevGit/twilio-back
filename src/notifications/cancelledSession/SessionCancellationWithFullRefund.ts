...
const EMAIL_SESSION_CANCELLED_WITH_FULL_REFUND_CONSUMER_TEMPLATE_ID =
  Env.getString('EMAIL_SESSION_CANCELLED_WITH_FULL_REFUND_CONSUMER_TEMPLATE_ID')

export const SessionCancelledWithFullRefundConsumerConfig =
  new NotificationConfig({
    id: NotificationType.SessionCancelledWithFullRefund,
    ...
    templates: [
      {
        ...
        externalBodyTemplateId:
          EMAIL_SESSION_CANCELLED_WITH_FULL_REFUND_CONSUMER_TEMPLATE_ID,
      },
    ],
  })
...
const EMAIL_SESSION_CANCELLED_WITH_FULL_REFUND_EXPERT_TEMPLATE_ID =
  Env.getString('EMAIL_SESSION_CANCELLED_WITH_FULL_REFUND_EXPERT_TEMPLATE_ID')
    ...
    templates: [
      {
        ...
        channels: [NotificationChannel.Email],
        externalBodyTemplateId:
          EMAIL_SESSION_CANCELLED_WITH_FULL_REFUND_EXPERT_TEMPLATE_ID,
      },
      {
...
export const queueCancelledSessionWithFullRefundNotifications = async (
